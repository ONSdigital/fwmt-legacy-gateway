...
public class LegacyJobPublishService {
  ...
  @Autowired
  public LegacyJobPublishService(TMService tmService, TMJobRepo tmJobRepo, TMUserRepo tmUserRepo)
  ...
  protected String getUsername(LegacySampleIngest ingest) {
    return tmUserRepo.findByAuthNo(ingest.getAuth()).getTmUsername();
  }
